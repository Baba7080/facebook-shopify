...
def oauth_shopify(req):
    ...
    scopes = "write_inventory,write_locations,read_customers,write_orders,read_locations,write_merchant_managed_fulfillment_orders,read_orders,write_products,read_products,write_resource_feedbacks,read_resource_feedbacks"
    url = "https://" + shop + "/admin/oauth/authorize?client_id=fe806c9fb2fc33a2cd2adbaac35ed29f&scope=" + scopes + "&redirect_uri=https://eccom.bytelinkup.com/connector/commense_auth/&state=1245"
...
def get_access_token(req):
    try:
        ...
        shop = req.GET['shop']
        url = 'https://'+shop+'/admin/oauth/access_token?client_id=fe806c9fb2fc33a2cd2adbaac35ed29f&client_secret=fe806c9fb2fc33a2cd2adbaac35ed29f&code='+code
